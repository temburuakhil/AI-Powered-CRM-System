...
import { AlertCircle, ClipboardList, MessageSquare, MessageCircle, Phone, Mail, Bell, FileText, LogOut } from "lucide-react";
      ...
      <main className={`flex-1 transition-all duration-300 overflow-x-hidden ${!isManager && (isSidebarCollapsed ? 'ml-16' : 'ml-64')}`}>
          ...
          <div className="flex items-center gap-4 flex-1 max-w-2xl">
            ...
            {isManager && (
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-base font-semibold">Schemes Manager</h1>
        ...
        <div className="max-w-[1800px] mx-auto p-8 space-y-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-[#7d8590]">Government schemes and services management</p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold text-[#e6edf3]">Government Schemes & Services</h2>
